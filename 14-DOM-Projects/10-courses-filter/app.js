courses = [
	...
	},
	{
		...
		category: "web-development", // JavaScript (general category for web development)
	},
	{
		id: 8,
		...
		description:
			"An overview of Artificial-Intelligence concepts, including search algorithms, knowledge representation, and machine reasoning.",
		category: "Artificial-Intelligence", // Artificial Intelligence
	},
	{
		id: 9,
...
function displayCourseButtons() {
	...
	const displayButtons = categories
		.map(function (cat) {
			return `<button class="btn filter-btn" data-id=${cat}>
            ${cat}
            </button>`;
		})
		.join("");
	btnContainer.innerHTML = displayButtons;
	// Crucial to place filter btns after adding them dynamically.
