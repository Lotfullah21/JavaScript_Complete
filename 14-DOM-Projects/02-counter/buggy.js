function Counter(element, value) {
  ...
  this.decreaseBtn.addEventListener("click", this.increase);
  this.reset.addEventListener("click", this.increase);
  console.log(element, value);
}

const firstCounter = new Counter(getElement(".first-counter"), 1200);
